...
client.on('interactionCreate', async interaction => {
    ...
    if(funny === 'first') {
        ...
        .setDescription("● To get help on a specific command type `@Groove help <command>`!")
        .setColor("#303037")
        .setFooter("Thanks For Choosing Groove Music | Groove Community", ee.footericon)
        .setTimestamp()
...
client.on('guildCreate', async (guild) => {
    ...
    client.channels.cache.get("914392086659350548").send({embeds: [embed]})
  ...
  try {
    ...
    const texts = "Hi, This Is Groove If You Need Support Related Me Join My Support Server. Support Server Link Is Here https://discord.gg/jt4ymeMWrR"
    const guildembed = new Discord.MessageEmbed()
    .setTitle("Thank you for adding me in your server! ❤️")
    .setColor("#303037")

    .setDescription(`\`\`\`fix\nMy prefix here is ${prefix}\nYou can see a list of commands by typing !help or !commands\nYou can change my prefix using !prefix <New Prefix>\`\`\``);
...
client.on('guildDelete', async (guild) => {
    try {
      ...
      client.channels.cache.get("914392085891788830").send({ embeds: [embed] })
    } catch (e) { console.log(e) }
});
